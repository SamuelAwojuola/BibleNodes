...
mainCanvas.addEventListener('mousemove',dragMoveFunction);
mainCanvas.addEventListener('mouseup',dragEndFunction);


function dragMoveFunction (e) {
    e.preventDefault();
    if (allowMouseMoveFunction == 1) {    
        ...
        dragStartMouseX = dragEndMouseX;
        dragStartMouseY = dragEndMouseY;
    }
}
...
function mouseDownFunction(e) {
    ...
    allowMouseMoveFunction = 1;
}

function dragEndFunction(e) {
    allowMouseMoveFunction = 0;
}